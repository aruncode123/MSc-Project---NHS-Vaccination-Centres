...
<body>
    ...
    <!-- Location Table Code included from seperate file to increade read ability of code and easy understandable.-->
    <?php include 'Components/locationTable.php' ?>
    
    <!-- Location Edit Modal Code included from seperate file to increade read ability of code and easy understandable.-->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
              $(".location-edit-btn").on("click",function(){
                ...
                $.ajax({
                  type:"GET",
                  url:"Php/getSingleLocation.php",
                  data:{id:id},
                  success:function(data){
                    data=JSON.parse(data);
                    console.log(data);
                    $("#updateLocationId").val(data[0].id)
